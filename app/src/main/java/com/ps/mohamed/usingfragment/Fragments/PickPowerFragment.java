...
public class PickPowerFragment extends Fragment {
    ...
    private OnPickPowerFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnPickPowerFragmentInteractionListener) {
            mListener = (OnPickPowerFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnPickPowerFragmentInteractionListener {
